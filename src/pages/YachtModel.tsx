...
const YachtModelPage: React.FC = () => {
  ...
  useEffect(() => {
    // Scroll to top immediately when model changes
    window.scrollTo({
      top: 0,
      left: 0,
      behavior: 'instant'
  ...
  }, [modelId]); // Trigger when modelId changes
    ...
    <div className="min-h-screen bg-gradient-to-b from-navy-950 to-navy-900 overflow-hidden">
      ...
      <div ref={heroRef} className="relative min-h-[100vh] w-full overflow-hidden pb-20 sm:pb-24 md:pb-32">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center z-10 px-4 sm:px-6 pt-20 sm:pt-24 md:pt-28 lg:pt-32">
          <div className="container mx-auto text-center max-w-6xl">
            ...
            >
              <div className="inline-flex items-center px-4 py-2 sm:px-6 sm:py-3 bg-navy-800/50 backdrop-blur-lg rounded-full text-xs sm:text-sm uppercase tracking-wider hover:bg-navy-800/70 transition-all duration-300 border border-white/50/30 group cursor-pointer">
                <Ship className="w-3 h-3 sm:w-4 sm:h-4 mr-2 opacity-90 group-hover:animate-pulse text-white" />
                <span className="text-white font-medium">{shipyardData.name}</span>
                <div className="ml-3 w-2 h-2 bg-white/40 rounded-full animate-pulse"></div>
              </div>
            </motion.div>
            ...
            >
              <div className="text-xs sm:text-sm uppercase tracking-[0.2em] bg-navy-900/20 text-white rounded-full px-3 py-1 sm:px-4 sm:py-2 backdrop-blur-sm border border-white/40 font-medium">
                Luxury Yacht
              </div>
            </motion.div>
            ...
            >
              <span className="text-base sm:text-lg md:text-xl lg:text-2xl text-white font-light tracking-wide">
            ...
            >
              <div className="grid grid-cols-2 sm:flex sm:flex-wrap justify-center items-center gap-3 sm:gap-4 lg:gap-8 max-w-4xl mx-auto">
                ...
                <div className="flex flex-col items-center text-center group">
                  <motion.div 
                    className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center mb-2 border border-white/50/30 group-hover:border-white/40/60 transition-all duration-300"
                    whileHover={{ scale: 1.1, rotate: 5 }}
                  >
                    <Maximize className="w-3 h-3 sm:w-4 sm:h-4 lg:w-5 lg:h-5 text-white" />
                  </motion.div>
                ...
                <div className="flex flex-col items-center text-center group">
                  <motion.div 
                    className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center mb-2 border border-white/50/30 group-hover:border-white/40/60 transition-all duration-303"
                    whileHover={{ scale: 1.1, rotate: -5 }}
                  >
                ...
                <div className="flex flex-col items-center text-center group">
                  <motion.div 
                    ...
                    whileHover={{ scale: 1.1, rotate: 5 }}
                  >
                    <Gauge className="w-3 h-3 sm:w-4 sm:h-4 lg:w-5 lg:h-5 text-white" />
                  </motion.div>
                ...
                <div className="flex flex-col items-center text-center group">
                  <motion.div 
                    ...
                    whileHover={{ scale: 1.1, rotate: -5 }}
                  >
                    <Layers className="w-3 h-3 sm:w-4 sm:h-4 lg:w-5 lg:h-5 text-white" />
                  </motion.div>
            ...
            >
              ...
              >
              <Button 
                  className="w-full sm:w-auto bg-gradient-to-r from-white to-white hover:from-white hover:to-white text-navy-900 px-5 py-2.5 sm:px-6 sm:py-3 lg:px-8 lg:py-4 rounded-full text-sm sm:text-base lg:text-lg font-semibold transition-all duration-300 group shadow-xl shadow-white/50/30 hover:shadow-2xl hover:shadow-white/50/40 border border-white/40/20"
              ...
              >
                <Button 
                  className="w-full sm:w-auto bg-navy-900/20 backdrop-blur-md border border-white/30 text-white hover:bg-navy-900/30 hover:border-white/50 px-5 py-2.5 sm:px-6 sm:py-3 lg:px-8 lg:py-4 rounded-full text-sm sm:text-base lg:text-lg transition-all duration-300 group font-medium"
        ...
        <div className="absolute right-6 lg:right-8 top-1/2 transform -translate-y-1/2 z-20 hidden lg:flex flex-col space-y-3">
          ...
          <motion.div 
              key={section}
              className="w-3 h-3 rounded-full border-2 border-white/30 cursor-pointer hover:border-white/40 transition-colors group relative"
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6">
              ...
              <>
                <div className="flex flex-col items-center text-center p-4 sm:p-6 lg:p-8 border-r border-b md:border-b-0 border-white/10">
                  <div className="bg-navy-800/80 rounded-full p-2 sm:p-3 mb-3 sm:mb-4">
                    <Maximize className="h-4 w-4 sm:h-6 sm:w-6 lg:h-8 lg:w-8 text-white" />
                  </div>
                ...
                <div className="flex flex-col items-center text-center p-4 sm:p-6 lg:p-8 border-b md:border-b-0 md:border-r border-white/10">
                  <div className="bg-navy-800/80 rounded-full p-2 sm:p-3 mb-3 sm:mb-4">
                    <Droplet className="h-4 w-4 sm:h-6 sm:w-6 lg:h-8 lg:w-8 text-white" />
                  </div>
                ...
                <div className="flex flex-col items-center text-center p-4 sm:p-6 lg:p-8 border-r border-b lg:border-b-0 border-white/10">
                  <div className="bg-navy-800/80 rounded-full p-2 sm:p-3 mb-3 sm:mb-4">
                    <Wind className="h-4 w-4 sm:h-6 sm:w-6 lg:h-8 lg:w-8 text-white" />
                  </div>
                ...
                <div className="flex flex-col items-center text-center p-4 sm:p-6 lg:p-8 border-b lg:border-b-0 lg:border-r border-white/10">
                  <div className="bg-navy-800/80 rounded-full p-2 sm:p-3 mb-3 sm:mb-4">
                    <Gauge className="h-4 w-4 sm:h-6 sm:w-6 lg:h-8 lg:w-8 text-white" />
                  </div>
                ...
                <div className="flex flex-col items-center text-center p-4 sm:p-6 lg:p-8 border-r border-white/10">
                  <div className="bg-navy-800/80 rounded-full p-2 sm:p-3 mb-3 sm:mb-4">
                    <Sofa className="h-4 w-4 sm:h-6 sm:w-6 lg:h-8 lg:w-8 text-white" />
                  </div>
            ...
            {!extendedModelData?.specs && (
              <>
                ...
                <div className="flex flex-col items-center text-center p-4 sm:p-6 lg:p-8 border-b md:border-b-0 md:border-r border-white/10">
                  <div className="bg-navy-800/80 rounded-full p-2 sm:p-3 mb-3 sm:mb-4">
                    <Ship className="h-4 w-4 sm:h-6 sm:w-6 lg:h-8 lg:w-8 text-white" />
                  </div>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 md:py-24">
        ...
        >
          <div className="flex flex-col items-center mb-12">
            <div className="inline-block mb-6">
              <div className="bg-white/40/20 rounded-full p-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {gallery.map((image, index) => (
              <motion.div 
                ...
                className="group overflow-hidden rounded-xl shadow-lg cursor-pointer transition-all duration-500 hover:shadow-2xl hover:shadow-white/50/10 relative border border-white/10 hover:border-white/40/30"
                onClick={() => {
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 text-white bg-gradient-to-t from-navy-900/90 via-navy-900/60 to-transparent z-20">
                  ...
                  <div className="w-0 h-0.5 bg-white/40 transition-all duration-500 group-hover:w-24 mb-2"></div>
                    ...
                    {gallery.map((img, idx) => (
                      <button
                        ...
                        className={`w-12 h-12 rounded-full flex-shrink-0 overflow-hidden border-2 transition-all ${
                          idx === activeModalImage ? 'border-white/40 scale-110' : 'border-transparent opacity-70'
                        }`}
                      >
                        <img 
                          src={img} 
        ...
        <Tabs defaultValue="overview" onValueChange={handleTabChange} className="w-full mb-24">
          ...
          >
            <TabsList className="grid w-full max-w-2xl grid-cols-3 gap-2 sm:gap-3 px-2 sm:px-4 bg-transparent">
              <TabsTrigger 
                value="overview" 
                className="rounded-lg py-3 sm:py-4 text-sm sm:text-base font-semibold text-white bg-gradient-to-br from-navy-600/80 to-navy-900/80 backdrop-blur-md border border-white/20 shadow-lg hover:shadow-white/50/20 hover:-translate-y-1 data-[state=active]:bg-gradient-to-br data-[state=active]:from-white data-[state=active]:to-white data-[state=active]:text-navy-900 data-[state=active]:border-white/20 data-[state=active]:shadow-xl transition-all duration-300"
              >
          ...
          <TabsContent value="overview" className="animate-fade-in">
            ...
            >
              <div className="lg:w-1/2">
                ...
                >
                  <div className="absolute -top-6 -left-6 w-24 h-24 border-l-2 border-t-2 border-white/40/70"></div>
                  <img 
                    src={gallery[0] || modelData.thumbnail} 
                    alt={modelData.name} 
                    className="w-full h-auto object-cover rounded-lg shadow-2xl"
                  />
                  <div className="absolute -bottom-6 -right-6 w-24 h-24 border-r-2 border-b-2 border-white/40/70"></div>
                </motion.div>
                ...
                >
                  <h3 className="text-xl font-medium text-white mb-6 flex items-center">
                    <Award className="w-5 h-5 mr-3 text-white" />
                  ...
                  <Link 
                    to={`/shipyard/${shipyardData.id}`}
                    className="inline-flex items-center mt-6 text-white hover:text-white group"
                  >
              ...
              <div className="lg:w-1/2">
                ...
                >
                  <h2 className="text-4xl md:text-5xl font-playfair font-semibold text-white mb-6 flex items-center">
                    <span className="bg-white/40/20 rounded-full p-2 mr-4">
            ...
            {activeTab === 'specifications' && (
              <TabsContent value="specifications" className="space-y-8">
                <motion.div 
                  ...
                  className="bg-white rounded-xl p-8 md:p-10 shadow-xl shadow-navy-900/5 border border-white"
                >
                  <h3 className="text-2xl sm:text-3xl font-playfair font-semibold text-navy-900 mb-6 relative">
                    Technical Specifications
                    <motion.div 
                      className="absolute -bottom-3 left-0 h-1 bg-gradient-to-r from-white to-white"
                      initial={{ width: 0 }}
                      animate={{ width: "4rem" }}
                      transition={{ duration: 0.8, delay: 0.3 }}
                    ></motion.div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 mt-8">
                    <motion.div 
                      ...
                      className="bg-white/50 rounded-xl p-6 border border-white/10 hover:shadow-lg transition-all duration-300"
                      whileHover={{ y: -5, transition: { duration: 0.2 } }}
                    >
                      <h4 className="text-lg font-semibold text-navy-800 mb-6 flex items-center">
                        <Ship className="mr-3 h-5 w-5 text-white" />
                        Dimensions & Capacity
                      </h4>
                      <ul className="space-y-4 sm:space-y-6">
                        <motion.li 
                          ...
                          className="flex justify-between items-center border-b border-white/10 pb-3 group hover:bg-white px-2 rounded-lg transition-colors duration-300"
                        >
                          <span className="text-slate-700 group-hover:text-navy-800 transition-colors duration-300">Length</span>
                          <span className="font-medium text-navy-900 bg-white px-3 py-1 rounded-md">{modelData.length}</span>
                        </motion.li>
                        <motion.li 
                          initial={{ opacity: 0, x: -10 }}
                          animate={{ opacity: 1, x: 0 }}
                        ...
                        >
                          ...
                          <span className="font-medium text-navy-900 bg-white px-3 py-1 rounded-md">{modelData.specs.cabins}</span>
                        </motion.li>
                        <motion.li 
                          initial={{ opacity: 0, x: -10 }}
                          animate={{ opacity: 1, x: 0 }}
                        ...
                        >
                          ...
                          <span className="font-medium text-navy-900 bg-white px-3 py-1 rounded-md">{modelData.specs.guests}</span>
                        </motion.li>
                        <motion.li 
                          initial={{ opacity: 0, x: -10 }}
                          animate={{ opacity: 1, x: 0 }}
                        ...
                        >
                          ...
                          <span className="font-medium text-navy-900 bg-white px-3 py-1 rounded-md">5.2 m / 17 ft</span>
                        </motion.li>
                        <motion.li 
                          initial={{ opacity: 0, x: -10 }}
                          animate={{ opacity: 1, x: 0 }}
                        ...
                        >
                          ...
                          <span className="font-medium text-navy-900 bg-white px-3 py-1 rounded-md">1.6 m / 5.2 ft</span>
                        </motion.li>
                      </ul>
                    </motion.div>
                    ...
                    >
                      <h4 className="text-lg font-semibold text-navy-800 mb-6 flex items-center">
                        <Gauge className="mr-3 h-5 w-5 text-white" />
                        Performance & Power
                      </h4>
                      <ul className="space-y-4 sm:space-y-6">
                        <motion.li 
                        ...
                        >
                          ...
                          <span className="font-medium text-navy-900 bg-white px-3 py-1 rounded-md">{modelData.specs.engines || 'Twin engines'}</span>
                        </motion.li>
                        <motion.li 
                          initial={{ opacity: 0, x: -10 }}
                          animate={{ opacity: 1, x: 0 }}
                        ...
                        >
                          ...
                          <span className="font-medium text-navy-900 bg-white px-3 py-1 rounded-md">{modelData.specs.maxSpeed}</span>
                        </motion.li>
                        <motion.li 
                          initial={{ opacity: 0, x: -10 }}
                          animate={{ opacity: 1, x: 0 }}
                        ...
                        >
                          ...
                          <span className="font-medium text-navy-900 bg-white px-3 py-1 rounded-md">22 knots</span>
                        </motion.li>
                        <motion.li 
                          initial={{ opacity: 0, x: -10 }}
                          animate={{ opacity: 1, x: 0 }}
                        ...
                        >
                          ...
                          <span className="font-medium text-navy-900 bg-white px-3 py-1 rounded-md">3,500 L / 925 gal</span>
                        </motion.li>
                        <motion.li 
                          initial={{ opacity: 0, x: -10 }}
                          animate={{ opacity: 1, x: 0 }}
                        ...
                        >
                          ...
                          <span className="font-medium text-navy-900 bg-white px-3 py-1 rounded-md">300 nm</span>
                        </motion.li>
                      </ul>
                    </motion.div>
                  </div>
                  ...
                  <motion.div 
                    ...
                    className="mt-10 bg-white/50 rounded-xl p-6 border border-white/10 hover:shadow-lg transition-all duration-300"
                  >
                    <h4 className="text-lg font-semibold text-navy-800 mb-6 flex items-center">
                      <Cpu className="mr-3 h-5 w-5 text-white" />
                ...
                >
                      ...
                      <motion.button 
                        ...
                        className={`px-6 py-3 rounded-full text-sm font-medium transition-all duration-300 ${
                          activeFeatureCategory === category 
                            ? 'bg-gradient-to-r from-white to-white text-white shadow-lg shadow-white/50/20 scale-105' 
                            : 'bg-white text-slate-700 hover:bg-white/10 border border-white/10'
                        }`}
                  ...
                  {modelData.features && modelData.features[activeFeatureCategory] && (
                    <motion.div
                      ...
                      className="bg-white/70 p-6 rounded-xl border border-white/10"
                    >
        ...
        <motion.div 
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, delay: 0.5 }}
          className="bg-gradient-to-r from-white via-white to-white rounded-xl p-10 sm:p-12 md:p-16 text-white text-center shadow-2xl shadow-white/20 mb-24 overflow-hidden relative"
        >
          {/* Decorative elements */}
          ...
          <div className="relative z-10">
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6 }}
              className="w-16 h-16 mx-auto rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center mb-8 border border-white/30/20"
            >
            ...
            <motion.div 
              ...
              animate={{ width: "80px" }}
              transition={{ duration: 0.8, delay: 0.3 }}
              className="h-1 bg-gradient-to-r from-white to-white mx-auto mb-8"
            />
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-6">
              <Link 
                to="/contact" 
                className="inline-flex items-center justify-center bg-white text-navy-900 hover:bg-white px-8 py-4 rounded-full text-lg font-medium transition-all duration-300 shadow-lg hover:shadow-xl shadow-navy-900/20 hover:shadow-navy-900/30 group"
              >
                <Anchor className="mr-2 h-5 w-5 text-white transition-transform group-hover:rotate-12" />
      ...
      <div className="bg-gradient-to-b from-white to-white py-20 sm:py-24 md:py-32 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col items-center mb-16">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-white to-white mb-6"></div>
            ...
            {shipyardData.models
              ...
              .map((model, index) => (
                <motion.div
                  ...
                  className="bg-white rounded-xl overflow-hidden shadow-xl hover:shadow-2xl shadow-white/10 hover:shadow-white/20 transition-all duration-500 transform hover:-translate-y-2 group border border-white"
                >
                  <div className="relative h-48 sm:h-56 overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-t from-white/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 z-10"></div>
                    <img 
                      src={model.thumbnail} 
                      alt={model.name} 
                      className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                    />
                    <div className="absolute top-4 right-4 bg-white/80 backdrop-blur-sm text-navy-900 text-xs px-3 py-1 rounded-full shadow-lg z-20">
                      {model.length.split(' ')[0]}
                    </div>
                  </div>
                  
                  <div className="p-6 sm:p-8">
                    <h3 className="text-xl font-playfair font-semibold text-white mb-3 group-hover:text-white transition-colors duration-300">{model.name}</h3>
                    ...
                    <Link 
                      to={`/model/${model.id}`} 
                      className="inline-flex items-center text-white font-medium hover:text-white group"
                    >
          ...
          <div className="text-center mt-12">
            <Link 
              to={`/shipyard/${shipyardData.id}`}
              className="inline-flex items-center justify-center px-8 py-3 bg-navy-900/20 hover:bg-navy-900/30 text-white rounded-full transition-all duration-300 border border-white/30 font-medium"
            >
              <span>View all {shipyardData.name} models</span>
