    ...
    <div className="relative h-screen min-h-[800px] w-full overflow-hidden pt-20 md:pt-0">
      ...
      <div className="absolute inset-0">
        <video
          ...
          poster="/38bowriderlowres1.jpg"
        >
          <source src="/homepage.mp4" type="video/mp4" />
          <div className="absolute inset-0 bg-cover bg-center bg-[url('/38bowriderlowres1.jpg')]" />
        </video>
        
        {/* Video overlay gradients */}
        <div className="absolute inset-0 bg-gradient-to-b from-navy-950/60 via-navy-900/45 to-navy-950/75"></div>
